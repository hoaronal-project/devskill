...
$(document).ready(function() { 
	...
	$(document).on('click', '.js_modal-save', function(){
		...
		if(section === "summary"){
			...
			var object   = {'refer_name':refer_name,'refer_email':refer_email,'refer_phone':refer_phone,'refer_profession':refer_profession};
			if(refer_phone !== ""){
...
function getAutoSaveJson() {
	...
	fontsize  = $('#rangeFontSize').val();    
	linespacing     = $('#rangeLineSpacing').val();    
	var edit_page = JSON.stringify({'font':font,'fontsize':fontsize,'linespacing':linespacing,'color':color},null,4);
